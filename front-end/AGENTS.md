...
Projeto local de front-end (React + Vite + TypeScript).
...
- implementar tasks classificadas como `front`
...
Skills locais em `.agents/skills/` sao focadas em implementacao front-end.
Planejamento global e change request devem ser feitos por skills da raiz.

## Regra visual

- usar `../design-system/front/` como referencia visual primaria para UI
